...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      {"@type":"Question","name":"Mogu li da otkažem ili promenim rezervaciju?","acceptedAnswer":{"@type":"Answer","text":"Putovanje ne može da se otkaže ukoliko je rezervacija napravljena u roku od 90 dana pre polaska, jer karte i smeštaj rezervišemo unapred. Postoje opcije: fleksibilne karte kao dodatak, upit pre zvanične rezervacije, ili poklon putovanje gde primalac koristi vaučer kod za bilo koje naše putovanje uključujući i prilagođena putovanja."}},
      {"@type":"Question","name":"Da li mogu da poklonim putovanje nekome?","acceptedAnswer":{"@type":"Answer","text":"Da! Postoje tri opcije: poklon vaučer koji primalac koristi pri rezervaciji bilo kog Escapii putovanja, rezervacija konkretnog putovanja uz opciju Pokloni ovo putovanje, ili personalizovana ponuda prilagođena željenom datumu, trajanju i budžetu."}},
      ...
      {"@type":"Question","name":"Da li mogu da putujem sam/sama?","acceptedAnswer":{"@type":"Answer","text":"Apsolutno, imamo puno solo Escapera! Jedina napomena je da se za jednokrevetnu sobu primenjuje jednokratna doplata od 60€ na cenu putovanja, jer se hotelske sobe standardno rezervišu za dve osobe. Sve ostalo funkcioniše potpuno isto kao i za grupe."}},
...
<main class="fq-wrap">
  ...
  <section class="fq-group" data-group="cena">
    ...
    <details class="faq">
      ...
      <div class="faq-a"><div class="faq-a-inner" data-i18n-html="a11">Nakon što pošalješ upit, naša ekipa će te kontaktirati u roku od 24h sa svim detaljima i podacima za uplatu. Rezervacija se potvrđuje tek nakon izvršene uplate. Po završetku uplate, dobijaš potvrdu na mejl.<br><br>Uplata se vrši na račun partnerske turističke agencije, bez naknade za karticu i bez skrivenih troškova. Cena koju vidiš na sajtu je cena koju plaćaš.</div></div>
    </details>
  </section>
  ...
  <section class="fq-group" data-group="dest">
    ...
    <details class="faq">
      ...
      <div class="faq-a"><div class="faq-a-inner" data-i18n-html="a5">Da, možeš! Prilikom rezervacije imaš opciju da isključiš destinacije na koje ne bi hteo/la da ideš.<br><br>Ako putuješ iz <strong>Beograda</strong>, možeš isključiti do 4 destinacije: prva je besplatna, a svaka sledeća se doplaćuje 10€ po osobi. Ipak, ne savetujemo da isključuješ više od 2-3, jer što manje isključuješ, veće je iznenađenje.<br><br>Ako putuješ iz <strong>Niša</strong>, zbog manjeg izbora dostupnih destinacija trenutno nije moguće isključiti pojedinačne destinacije.</div></div>
    </details>
  </section>
  ...
  <section class="fq-group" data-group="poklon">
    ...
    <details class="faq">
      ...
      <div class="faq-a"><div class="faq-a-inner" data-i18n-html="a7">Da, apsolutno! Postoje tri opcije za poklon putovanje:<br><br><strong>Poklon vaučer</strong>: na stranici <a href="/pokloni-putovanje-iznenadjenja">Pokloni iznenađenje</a> biraš iznos vaučera, unosiš ime i poruku, a mi šaljemo elegantni PDF vaučer koji primalac koristi pri rezervaciji bilo kog Escapii putovanja.<br><br><strong>Poklon kroz rezervaciju</strong>: u booking formi uključiš opciju "Pokloni ovo putovanje", odabereš termin i dodatke, a na kraju nam kažeš kome poklanjaš i ostaviš poruku. Primalac na svoj mejl dobija prognozu, otkrivanje destinacije i putne dokumente, a ti podatke za uplatu i elegantni PDF vaučer koji možeš da proslediš ili odštampaš.<br><br><strong>Personalizovana ponuda</strong>: javi nam se i kreiraćemo ponudu prilagođenu željenom datumu, trajanju i budžetu.<br><br>Naši Escaperi najčešće poklanjaju putovanja iznenađenja za rođendane, godišnjice, devojačke i momačke večeri, jer avantura koja se pamti uvek pobeđuje svaki materijalni poklon.</div></div>
    </details>
...
const I18N_EN = {
  ...
  'sub':'From pricing and destinations to cancellations and gifts, here are the answers to all your questions about Escapii surprise trips.',
  'cat.all':'All',
  ...
  'a4':'We get it, and that\'s a completely valid question. It\'s possible you\'ll receive a destination you wouldn\'t have picked yourself, but that\'s kind of the whole point. Sometimes it\'s not about where you are, but what you experience when you get there. Our trips are short weekend adventures, and every destination in our pool has plenty to see, do, and discover. On top of that, you\'ll get our guide with insider tips, local recommendations, discounts, and ideas for making the most of 2-3 days in that city. Many of our travellers have come back with a completely different view, of the destination and of what travel even means.',
  'q5':'Can I exclude destinations?',
  'a5':'Yes, you can! During booking, you have the option to exclude destinations you don\'t want to visit.<br><br>If you\'re departing from <strong>Belgrade</strong>, you can exclude up to 4 destinations: the first one is free, and each additional one costs €10 per person. Still, we don\'t recommend excluding more than 2-3, because the fewer you exclude, the bigger the surprise.<br><br>If you\'re departing from <strong>Niš</strong>, due to the smaller destination pool, you currently cannot exclude destinations.',
  'q6':'Can I cancel or change my booking?',
  'a6':'Unfortunately, trips cannot be canceled. We offer competitive prices precisely because we book flights and accommodation in advance, which means cancellations are not possible once a reservation is made within 90 days of departure.<br><br>However, there are a few options that may help:<br>- If you\'re not sure which date will suit you, send us an inquiry with the dates that suit you best before you officially book.<br>- As an add-on, you can choose <strong>flexible tickets</strong>, which give you the option to change dates.<br>- If you\'re thinking of a gift, the "Gift Surprise Trip" option lets the recipient use a voucher code for any of our trips, including custom trips.<br><br>Hotels can in some cases be canceled, depending on the specific trip conditions.',
  'q7':'Can I give a trip as a gift?',
  'a7':'Yes, absolutely! There are three ways to gift a surprise trip:<br><br><strong>Gift voucher</strong>: on the <a href="/pokloni-putovanje-iznenadjenja">Pokloni iznenađenje</a> page, choose a voucher amount, enter a name and message, and we\'ll send a beautifully designed PDF voucher the recipient uses when booking any Escapii trip.<br><br><strong>Gift through booking</strong>: in the booking form, turn on the "Gift this trip" option, pick your dates and add-ons, and at the end tell us who the gift is for and leave a message. The recipient gets the forecast, the destination reveal and the travel documents by email, while you get the payment details and a beautifully designed PDF voucher to forward or print.<br><br><strong>Personalized offer</strong>: just reach out and we\'ll create an offer tailored to the dates, duration, and budget that works for you.<br><br>Our Escapers most often give surprise trips for birthdays, anniversaries and bachelor and bachelorette parties, because an adventure you remember always beats any material gift.',
  ...
  'a9':'Absolutely, we have plenty of solo Escapers! The only thing to note is that a <strong>one-time single room supplement of 60€</strong> applies, since hotel rooms are standardly reserved for two people. Everything else works exactly the same as for groups.',
  ...
  'a11':'After you submit your inquiry, our team will contact you within 24 hours with all the details and payment information. Your booking is confirmed only after payment is received. Once payment is completed, you\'ll receive a confirmation by email.<br><br>Payment is made to our partner travel agency\'s account, with no card fees and no hidden costs. The price you see on the site is the price you pay.',
  'q12':'How does a gift voucher work?',
  'a12':'A gift voucher is the perfect gift for someone who loves surprises and travel. On the <a href="/pokloni-putovanje-iznenadjenja"><strong>Pokloni iznenađenje</strong></a> page, choose a voucher amount, enter a name and a personal message, and we\'ll send a beautifully designed PDF voucher (boarding pass style) ready to forward or print.<br><br>The recipient enters the voucher code when booking an Escapii trip, and the amount is deducted from the total price. Vouchers are valid for <strong>one year from activation</strong> and can be used on any Escapii trip. Vouchers cannot be exchanged for cash.',
  ...
  'ft.how':'How it works', 'ft.faq':'FAQ', 'ft.gift':'🎁 Gift a Surprise Trip',
