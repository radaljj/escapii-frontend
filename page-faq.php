...
const I18N_EN = {
  ...
  'a5':'Yes, you can! During booking, you have the option to exclude destinations you don\'t want to visit.<br><br>If you\'re departing from <strong>Belgrade</strong>, you can exclude up to 4 destinations: the first one is free, and each additional costs +€10 per person.<br><br>If you\'re departing from <strong>Niš</strong>, due to the smaller destination pool, you currently cannot exclude destinations.',
