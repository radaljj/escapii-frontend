...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      {"@type":"Question","name":"Mogu li da isključim destinacije?","acceptedAnswer":{"@type":"Answer","text":"Da! Ako putuješ iz Beograda, možeš isključiti do 4 destinacije - prva je besplatna, a svaka sledeća se doplaćuje 15€. Ako putuješ iz Niša, zbog manjeg izbora dostupnih destinacija trenutno nije moguće isključiti pojedinačne destinacije."}},
...
const I18N_EN = {
  ...
  'a5':'Yes, you can! During booking, you have the option to exclude destinations you don\'t want to visit.<br><br>If you\'re departing from <strong>Belgrade</strong>, you can exclude up to 4 destinations - the first one is free, and each additional costs +15€.<br><br>If you\'re departing from <strong>Niš</strong>, due to the smaller destination pool, you currently cannot exclude destinations.',
