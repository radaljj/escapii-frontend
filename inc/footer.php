...
<footer class="esc-footer">
  <div class="footer-main">
    <div class="footer-brand">
      ...
      <p data-i18n="ft.desc"><?php echo $_f_lang === 'en' ? 'Surprise trips for people ready to let go of control and try something different.' : 'Iznenađujuća putovanja za ljude koji su spremni da puste kontrolu i probaju nešto drugačije.'; ?></p>
      <div class="footer-social">
        <h4 data-i18n="ft.follow"><?php echo $_f_lang === 'en' ? 'Follow us' : 'Pratite nas'; ?></h4>
    ...
    <div class="footer-col">
      <h4 data-i18n="ft.nav"><?php echo $_f_lang === 'en' ? 'Navigation' : 'Navigacija'; ?></h4>
    ...
    <div class="footer-col">
      <h4 data-i18n="ft.dep"><?php echo $_f_lang === 'en' ? 'Departures' : 'Polasci'; ?></h4>
      <a href="<?php echo esc_url($_f_home); ?>/#esc-booking">✈ Beograd (BEG)</a>
      <a href="<?php echo esc_url($_f_home); ?>/#esc-booking">✈ Niš (INI)</a>
    </div>
    <div class="footer-col">
      <h4 data-i18n="ft.contact"><?php echo $_f_lang === 'en' ? 'Contact' : 'Kontakt'; ?></h4>
      <a href="mailto:info@escapii.rs">✉ info@escapii.rs</a>
      <a href="javascript:void(0)" onclick="openStatusModal()" data-i18n="ft.status">🔍 <?php echo $_f_lang === 'en' ? 'Check booking status' : 'Proveri status rezervacije'; ?></a>
    </div>
  </div>
  <div class="footer-divider"></div>
  <div class="footer-bottom">
    <span data-i18n="ft.rights"><?php echo $_f_lang === 'en' ? '© 2026 Escapii - All rights reserved' : '© 2026 Escapii - Sva prava zadržana'; ?></span>
